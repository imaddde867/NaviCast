...
logging.basicConfig(
    ...
    handlers=[
        RotatingFileHandler(str(LOG_DIR / 'prediction_service.log'), maxBytes=10485760, backupCount=5),
    ...
    try:
        ...
        for vessel_data in latest_data:
            ...
            try:
                ...
                predicted_lat = float(lat + delta_lat)
                predicted_lon = float(lon + delta_lon)
